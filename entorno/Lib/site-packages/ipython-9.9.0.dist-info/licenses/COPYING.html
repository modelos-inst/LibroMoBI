...
<html lang="en" data-content_root="../../../../../" >
  ...
  <head>
    ...
    <title>The IPython licensing terms &#8212; Libro Modelado de Sistemas Bajo Incertidumbre - IIND 2504</title>
...
<link rel="preload" as="script" href="../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'entorno/Lib/site-packages/ipython-9.9.0.dist-info/licenses/COPYING';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../_sources/entorno/Lib/site-packages/ipython-9.9.0.dist-info/licenses/COPYING.rst" target="_blank"
...
<span class="c1"># Distributed under the terms of the Modified BSD License.</span>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./entorno\Lib\site-packages\ipython-9.9.0.dist-info\licenses"
        },
